...
def percentage_match_win():
    (data.winner.value_counts(normalize=True)*100).plot(kind='barh',
...
def percentage_match_win_2008():
    (data2008.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()


def percentage_match_win_2009():
    (data2009.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()


def percentage_match_win_2010():
    (data2010.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()


def percentage_match_win_2011():
    (data2011.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()


def percentage_match_win_2012():
    (data2012.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()


def percentage_match_win_2013():
    (data2013.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()


def percentage_match_win_2014():
    (data2014.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()


def percentage_match_win_2015():
    (data2015.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()


def percentage_match_win_2016():
    (data2016.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()


def percentage_match_win_2017():
    (data2017.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()


def percentage_match_win_2018():
    (data2018.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()


def percentage_match_win_2019():
    (data2019.winner.value_counts(normalize=True)*100).plot(kind='barh',
                                                            title='Percentage of matches won by Teams', figsize=(10, 5))
    plt.show()
...
# PRCENTAGE MATCH PLAYED IN CITIES MAIN


def percentage_match_in_cities():
    (data.city.value_counts(normalize=True) * 100).plot(kind='pie',
...
def percentage_match_in_cities_2008():
    (data2008.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()


def percentage_match_in_cities_2009():
    (data2009.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()


def percentage_match_in_cities_2010():
    (data2010.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()


def percentage_match_in_cities_2011():
    (data2011.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()


def percentage_match_in_cities_2012():
    (data2012.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()


def percentage_match_in_cities_2013():
    (data2013.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()


def percentage_match_in_cities_2014():
    (data2014.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()


def percentage_match_in_cities_2015():
    (data2015.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()


def percentage_match_in_cities_2016():
    (data2016.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()


def percentage_match_in_cities_2017():
    (data2017.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()


def percentage_match_in_cities_2018():
    (data2018.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()


def percentage_match_in_cities_2019():
    (data2019.city.value_counts(normalize=True) * 100).plot(kind='pie',
                                                            title='Percentage Of Matches Played in Cities(All Seasons)', figsize=(10, 5))
    plt.show()
...
def percentage_toss_win():
    (data.toss_decision.value_counts(normalize=True)*100).plot(kind='barh',
...
def percentage_toss_win_2008():
    (data2008.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()


def percentage_toss_win_2009():
    (data2009.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()


def percentage_toss_win_2010():
    (data2010.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()


def percentage_toss_win_2011():
    (data2011.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()


def percentage_toss_win_2012():
    (data2012.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()


def percentage_toss_win_2013():
    (data2013.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()


def percentage_toss_win_2014():
    (data2014.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()


def percentage_toss_win_2015():
    (data2015.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()


def percentage_toss_win_2016():
    (data2016.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()


def percentage_toss_win_2017():
    (data2017.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()


def percentage_toss_win_2018():
    (data2018.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()


def percentage_toss_win_2019():
    (data2019.toss_decision.value_counts(normalize=True) *
     100).plot(kind='barh', title='Percentage of toss decisions(All Seasons)')
    plt.show()
...
def max_manofthematch():
    data.player_of_match.value_counts().head().plot(
...
def max_manofthematch_2008():
    data2008.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)
    plt.show()


def max_manofthematch_2009():
    data2009.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)
    plt.show()


def max_manofthematch_2010():
    data2010.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)
    plt.show()


def max_manofthematch_2011():
    data2011.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)
    plt.show()


def max_manofthematch_2012():
    data2012.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)
    plt.show()


def max_manofthematch_2013():
    data2013.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)
    plt.show()


def max_manofthematch_2014():
    data2014.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)
    plt.show()


def max_manofthematch_2015():
    data2015.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)
    plt.show()


def max_manofthematch_2016():
    data2016.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)
    plt.show()


def max_manofthematch_2017():
    data2017.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)


def max_manofthematch_2018():
    data2018.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)


def max_manofthematch_2019():
    data2019.player_of_match.value_counts().head().plot(
        kind='barh', title="Top Players Become max times--\'Man of The Match'", grid=True)
...
def favourite_venue():
    data.venue.value_counts().plot(kind='bar', title='Fav Grounds', figsize=(15, 8),
